...
CREATE TABLE students (
    ...
    -- Auto-incrementing ID, acts as Primary Key
    first_name VARCHAR(50) NOT NULL,
    -- Cannot be empty
    last_name VARCHAR(50),
    -- Can be null (some people only have one name!)
    email VARCHAR(100) UNIQUE NOT NULL,
    -- Must be unique across verify usually, and present
    phone_number CHAR(10) UNIQUE,
    -- Fixed length string for phone numbers
 ...
 */
docker exec - it sql_class_pg psql - U postgres CREATE DATABASE sql_class_1_db;
-- 1. Create a database (Optional, usually we are already in one)
-- CREATE DATABASE web_dev_cohort_db;
-- 2. Basic Table Creation with Data Types and Constraints
-- Let's model our "Web Dev Cohort 2026" students!
